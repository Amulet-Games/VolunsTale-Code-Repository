...
namespace SA
{
    public class MeleeAlterDetails : ItemAlterDetails
    {
        [Header("Generals.")]
        ...
        public void RedrawWeaponAlterDetails(RuntimeWeapon _runtimeWeapon)
        {
            ...
            UpdateWeaponAlterDetails();
            UpdateWeaponAlterDetails_ElementRelated();
        }

        protected virtual void UpdateWeaponAlterDetails()
        {
            /// General Info
        ...
        /// Element Related
        protected void UpdateWeaponAlterDetails_ElementRelated()
        {
