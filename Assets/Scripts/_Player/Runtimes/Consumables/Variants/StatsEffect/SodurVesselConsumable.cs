...
namespace SA
{
    public class SodurVesselConsumable : StatsEffectConsumable
    {
        [Header("Mat (Drops).")]
        ...
        {
            statsHandler.IncrementPlayerFocus(_referedStatsEffectItem.effectAmount);
        }
        ...
        public void RefillCarryingSodurAmount(int _amount)
        {
        ...
        {
            _inventory.SetupSodurVesselsDefault(this);
        ...
        {
            _inventory.runtimeSodurVessel = this;
