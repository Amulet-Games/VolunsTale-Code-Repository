...
namespace SA
{
    public class BFX_Handler_SetDoubleAndHalf : BFX_Handler_SetBase
    {
        ...
        void Init_Double_Half_BloodUpdater()
        {
            GroupInitRefs();
        ...
        public override void Tick()
        {
            ...
            BloodUpdater_Double_Half_Tick();

            DecalUpdater_Double_Tick();
        }

        void BloodUpdater_Double_Half_Tick()
        {
            bloodUpdater.Tick();
