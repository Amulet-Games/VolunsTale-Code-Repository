...
namespace SA
{
    public class BFX_Handler_SetTripleAndHalf : BFX_Handler_SetBase
    {
        ...
        [Header("Half. Drag and Drops.")]
        public BFX_BloodFxUpdater bloodUpdater_4th;
        ...
        void Init_Triple_Half_BloodUpdater()
        {
            GroupInitRefs();
            ...
            void GroupInitRefs()
            {
                ...
                bloodUpdater_4th._bfxHandler = this;
            }
        ...
        public override void Tick()
        {
            ...
            BloodUpdater_Triple_Half_Tick();

            DecalUpdater_Triple_Tick();
        }

        void BloodUpdater_Triple_Half_Tick()
        {
            bloodUpdater.Tick();
            bloodUpdater_2nd.Tick();
            bloodUpdater_3rd.Tick();
            bloodUpdater_4th.Tick();
        }
